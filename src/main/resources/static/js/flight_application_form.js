...
function validateFields() {
    ...
    var otherDoc = document.getElementById('otherDoc').value.trim();
     ...
     //setFocus(category);
        ...
        alert("Please ente a valid 10 digit mobile number");
        return false;
        ...
        return false;
    } //else if (reasonAvailingFlightService == "5") {
//        if (comments_Text == "" || comments_Text == null) {
//            alert("Please Enter Comments");
//            return false;
//        }
 //   }
 else if (tentitiveFlightDate == "" || tentitiveFlightDate == null) {
        alert("Please enter Tentetive Date");
        return false;

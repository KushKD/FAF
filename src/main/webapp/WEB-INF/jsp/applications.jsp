...
<main class="app-content">
	...
	<form:form method="POST" id="form" modelAttribute="viewApplications" action="${pageContext.request.contextPath}/filterApplications" class="form-signin">
		...
		<br>
			...
			<spring:bind path="appliactionStatus">
            					<div class="col-md-3 form-group  ${status.error ? 'has-error' : ''}">
            						<form:label path="appliactionStatus" for="appliactionStatus">Application Status</form:label>
            						<form:select path="appliactionStatus" name="appliactionStatus" class="form-control" id="appliactionStatus">
            						<form:option value="">--Select--</form:option>
            						<form:option value="A">Approved</form:option>
            						<form:option value="P">Pending</form:option>
            						<form:option value="R">Rejected</form:option>
            						</form:select>
            						<form:errors  path="appliactionStatus"></form:errors>
            					</div>
            				</spring:bind>
				...
				<spring:bind path="Date">
					<div class="col-md-3 form-group  ${status.error ? 'has-error' : ''}">
						...
						<form:input onkeypress="return alpha(event)" oncopy="return false" onpaste="return false" class="form-control" path="Date" id="demoDate" type="text" placeholder="Select Date" />

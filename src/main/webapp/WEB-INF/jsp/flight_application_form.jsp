...
<script type="text/javascript">
   $( document ).ready(function() {
      ...
      getFlightDistrictToGoFrom_dest();
      gethalipadDistrict();
   ...
   <form:form method="POST" onsubmit="return submit_form()" modelAttribute="flightApplicationForm" action="${pageContext.request.contextPath}/saveDetails" enctype="multipart/form-data" class="form-signin">
      ...
      <div class="container" style="padding-top:10px;" >
         ...
         <div class="breadcrumb">
            <ul>
               <li>
                  <spring:message code="instructions.head.one" text="Instructions Heading One"/>
               </li>
               <li>
                  <spring:message code="instructions.head.two" text="Instructions Heading Two"/>
               </li>
               <li>
                  <spring:message code="instructions.head.three" text="Instructions Heading Three"/>
               </li>
               <li>
                  <spring:message code="instructions.head.four" text="Instructions Heading Four"/>
               </li>
               <li>
                  <spring:message code="instructions.head.five" text="Instructions Heading Five"/>
               </li>
            </ul>
         </div>
         <div class="row">
            <div class="col-lg-12">
               <hr>
               <h2>
                  <spring:message code="form.application.Form" text="Flight Application Form for Patients/ Locals/ Others" />
               </h2>
               <hr>
            </div>
            <spring:bind path="category">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <label>
                     <spring:message code="form.user.category"  text="Category" />
                  </label>
            ...
            <spring:bind path="registrationType">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label  for="reservationType" path="registrationType">
                     <spring:message code="form.reservationType"  text="Type of Reservation" />
                  </form:label>
            ...
            <spring:bind path="fullName">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label  path="fullName" for="fullname">
                     <spring:message code="form.fullname"   text="Full Name" />
                  </form:label>
            ...
            <spring:bind path="relationPrifix">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label  path="relationPrifix" for="relation_prefix">
                     <spring:message code="form.parentname.prefix"  text="Relation Prefix" />
                  </form:label>
                  <form:select  path="relationPrifix" class="form-control" id="relationPrifix">
                     <form:option value="2">
                        <spring:message code="form.parentname.relation.do" text="D/O" />
                     </form:option>
                  </form:select>
            ...
            <spring:bind path="relationName">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label path="relationName" for="parentname">
                     <spring:message code="form.parentname.relation.name"   text="Parent Name"  />
                  </form:label>
            ...
            <spring:bind path="mobileNumber">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label path="mobileNumber" for="mobilenumber">
                     <spring:message code="form.mobilenumber"  text="Mobile Number" />
                  </form:label>
            ...
            <spring:bind path="age" >
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label path="age" for="age">
                     <spring:message code="form.age" text="Age" />
                  </form:label>
            ...
            <spring:bind path="weight">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label  path="weight"  for="weight">
                     <spring:message code="form.weight" text="Weight" />
                  </form:label>
            ...
            <spring:bind path="luggageWeight">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}" >
                  <label for="luggage_weight">
                     <spring:message code="form.estimated.luggage.weight" text="Luggage Weight (KG)" />
                  </label>
            ...
            <spring:bind path="permanentAddress">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <label for="address">
                     <spring:message code="form.address"  text="Address" />
                  </label>
            ...
            <spring:bind path="correspondenceAddress">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <label for="correspondence_address">
                     <spring:message code="form.correspondence.address"  text="Correspondence Address" />
                  </label>
         ...
         <div class="row" style="margin-bottom:10px;">
            <div class="col-lg-12">
               <hr>
               <strong>
                  <spring:message code="form.details.flight" text="Flight Details" />
               </strong>
               <hr>
            </div>
            <spring:bind path="reasonAvailingFlightService">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <label for="locales">
                     <spring:message code="form.reason.awailing.service"  text="Reasons for availing Flight Service." />
                  </label>
            ...
            <spring:bind path="comments">
               <div id="comments" class="form-group col-lg-4 ${status.error ? 'has-error' : ''}" style="display:none;">
                  <label for="comments">
                     <spring:message code="form.comments"  text="Comments" />
                  </label>
            ...
            <spring:bind path="tentitiveFlightDate">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <label for="serviceavailingDate">
                     <spring:message code="form.serviceavailingDate"  text="Tentative Date for availing flight Service" />
                  </label>
            ...
            <spring:bind path="serviceavailingDateto">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <label for="serviceavailingDateto">
                     <spring:message code="to.serviceavailingDate"  text="Tentative Date to availing flight Service" />
                  </label>
            ...
            <div class="row col-lg-12" style="margin-bottom:10px;">
               ...
               <spring:bind path="flightDistrictToGoFrom">
                  <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                     <label for="locales">
                        <spring:message code="form.togodistirct"  text="Select District" />
                     </label>
               ...
               <spring:bind path="flightHelipadNameToGoFrom">
                  <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                     <label for="locales">
                        <spring:message code="from.togohalipadname"  text="Select Helipad" />
                     </label>
            ...
            <div class="row col-lg-12" style="margin-bottom:10px;">
               ...
               <hr>
               <spring:bind path="flightDistrictToGoFrom_dest">
                  <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                     <label for="locales">
                        <spring:message code="form.togodistirct"  text="Select District" />
                     </label>
                     <form:select path="flightDistrictToGoFrom_dest" class="form-control" id="flightDistrictToGoFrom_dest" onchange="getFlightHelipadNameToGoFrom_dest(this.value)" >
                     </form:select>
                     <form:errors style="color:red;"  path="flightDistrictToGoFrom_dest"></form:errors>
                  </div>
               </spring:bind>
               <spring:bind path="flightHelipadNameToGoFrom_dest">
                  <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                     <label for="locales">
                        <spring:message code="from.togohalipadname"  text="Select Helipad" />
                     </label>
                     <form:select path="flightHelipadNameToGoFrom_dest" class="form-control" id="flightHelipadNameToGoFrom_dest">
                     </form:select>
                     <form:errors style="color:red;"  path="flightHelipadNameToGoFrom_dest"></form:errors>
                  </div>
               </spring:bind>
            </div>
            <spring:bind path="availedFlightBefore15">
               <div  class="form-innline col-lg-12 ${status.error ? 'has-error' : ''}">
                  <label >
                     <h6>
                        <spring:message code="form.service.availed.after.15.nov" text="Has the applicant availed the flight service after 15th Nov" />
                     </h6>
                  </label>
                  &nbsp; &nbsp;
            ...
            <spring:bind path="earlierFlightServiceEmergency">
               <div  class="form-innline col-lg-12 ${status.error ? 'has-error' : ''}">
                  <label >
                     <h6>
                        <spring:message code="from.service.availed.emergency.situation" text="Has the earlier flight service been availed in Emergency Situation" />
                     </h6>
                  </label>
                  &nbsp; &nbsp;
         ...
         <div class="row" style="margin-bottom:10px;">
            ...
            <div id="official_div" class="form-group col-lg-4">
               <label for="officeCardDoc" class="form-label">
            ...
            <div id="medical_div" class="form-group col-lg-4">
               <label for="medicalDoc" class="form-label">
            ...
            <div id="other_div" class="form-group col-lg-4">
               <label for="otherDoc" class="form-label">
         ...
         <div class="row">
            <spring:bind path="earlierService">
               <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
                  <form:label  path="relationPrifix" for="earlierService">
                     <spring:message code="form.previous.service"  text="Any Earlier Service" />
                  </form:label>
         ...
         <div id="tableDiv" style="display:none">
            ...
            <div class="row" style="margin-top:10px">
               ...
               <spring:bind path="halipadDistrict">
                  <div class="col-lg-4 ${status.error ? 'has-error' : ''}">
                     <div class="form-group">
                        <form:label for="username" path="halipadDistrict" class="field-label">
                           <spring:message code="form.halipadDistrict" text="From which District" />
                        </form:label>
               ...
               <spring:bind path="halipadLocation">
                  <div class="col-lg-4 ${status.error ? 'has-error' : ''}">
                     <div class="form-group">
                        <form:label path="halipadLocation">
                           <strong>
                              <spring:message code="form.halipadname" text="Helipad Name" />
                           </strong>
                        </form:label>

      ...
      <div class="row">
         ...
         <div class="form-group col-lg-4">
            ...
            <select class="form-control">
               <option value="">
                  <spring:message code="form.select" text="Please Select"/>
               </option>
               <option value="1">
                  <spring:message code="form.user.category.office" text="Official"/>
               </option>
               <option value="2">
                  <spring:message code="form.user.category.patient " text="Patient"/>
               </option>
               <option value="3">
                  <spring:message code="form.user.category.local" text="Local"/>
               </option>
               <option value="4">
                  <spring:message code="form.user.category.other" text="Other"/>
               </option>
            </select>
         </div>
         <div class="form-group col-lg-4">
            ...
            <select class="form-control" id="sel1">
               ...
               <option value="0">
                  <spring:message code="form.reservation.type.normal" text="Normal"/>
               </option>
               <option value="1">
                  <spring:message code="form.reservation.type.emergency" text="Emergency"/>
               </option>
            </select>
         </div>
         <div class="form-group col-lg-4">
         ...
         <div class="form-group col-lg-4">
            ...
            <select class="form-control" id="sel1">
               ...
               <option value="0">
                  <spring:message code="form.parentname.relation.so" text="S/O"/>
               </option>
               <option value="1">
                  <spring:message code="form.parentname.relation.wo" text="W/O"/>
               </option>
               <option value="2">
      ...
      <div class="row" style="margin-bottom:10px;">
         ...
         <div class="form-group col-lg-4">
            ...
            <select class="form-control" id="locales">
               ...
               <option value="en">
                  <spring:message code="form.reason.awailing.service.option.one" text="Emergency"/>
               </option>
               <option value="hi">
                  <spring:message code="form.reason.awailing.service.option.two" text="Examination"/>
               </option>
               <option value="hi">
                  <spring:message code="form.reason.awailing.service.option.three" text="Officail"/>
               </option>
               <option value="hi">
                  <spring:message code="form.reason.awailing.service.option.four" text="Other"/>
               </option>
            </select>
         </div>
         <div class="form-group col-lg-4">
